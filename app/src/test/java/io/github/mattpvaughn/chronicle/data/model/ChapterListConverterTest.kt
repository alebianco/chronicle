...
class ChapterListConverterTest {
  ...
  fun `large offsets survive as Long`() {
    ...
    val long = chapter.copy(startTimeOffset = 108_000_000L, endTimeOffset = 109_000_000L)

    val restored = converter.toChapterList(converter.toString(listOf(long)))

    assertEquals(108_000_000L, restored[0].startTimeOffset)
    assertEquals(109_000_000L, restored[0].endTimeOffset)
  }
