...
/**
 * Source ids for fixtures (decision-21).
 *
 ...
 *
 * This is the source-scoping fixture trap in a new field — three fixtures carried `source = 1L` where
 * every real row carried `0L`, and nothing noticed until the source-scoped removal made them
