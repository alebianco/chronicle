  ...
  constructor(
    ...
    override fun onPause() {
      if (!mediaController.playbackState.isPrepared) {
        ...
        // Persist on the way down: `ProgressUpdater`'s tick is gated on `isPlaying`, so pausing
        // stops it and the saved position is whatever the previous tick caught. A book switch and a
        // seek flush their own; an ordinary pause had nothing.
        //
