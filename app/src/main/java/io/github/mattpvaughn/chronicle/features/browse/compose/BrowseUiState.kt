...
/**
 * What the browse screen is showing, as one exhaustive state (cu-202).
 *
 ...
 * run. Same defect class as the home shelves' empty states (cu-201), and the reason
...
sealed interface BrowseContent {
   ...
   * not carry a caveat, or the caveat stops being read (cu-24).
   */
