 ...
 *
 * Extracted from `CurrentlyPlayingFragment.onCreateView` (cu-173), where they were local functions
 ...
 * source of the wording rule these obey (§3.1 rule 3, cu-19) — a two-level human-formatted readout
