---
id: cu-46
title: Audit and dissolve upstream todo.md
status: Done
assignee: []
...
- [x] Every open todo.md item mapped to a task/draft or consciously dropped
- [x] todo.md removed
- [x] No information lost (git history + new task files)
